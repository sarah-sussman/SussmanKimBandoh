...
Our data is from 10 USGS stream gauges in Western NC. We used the USGS R package "dataRetrieval" to pull the stream gauge data. Specifically, we used discharge (parameter code: #00060), pH (parameter code: #00400), and turbidity (parameter code: #00076). We pulled data from September 27, 2023 - March 27, 2023 and September 27 2024 - March 27, 2025.

Link to data: https://waterdata.usgs.gov/state/north-carolina/ 

The 10 USGS stream gauges we used are:
