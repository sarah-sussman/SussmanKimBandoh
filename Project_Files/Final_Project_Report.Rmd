...
This project has x research questions:
1. Has the overall discharge (cfs) at 10 Western NC USGS stream gages increased after Hurricane Helene?

\newpage

# Dataset Information

Our data is from 10 USGS stream gauges in Western NC. We used the USGS R package "dataRetrieval" to pull the stream gauge data. Specifically, we used discharge (parameter code: #00060). We were going to also look at pH (parameter code: #00400) and and turbidity (parameter code: #00076), but quuickly found that pH and turbidity are not measured at our 10 gage locations. We pulled data from September 27, 2023 - March 27, 2023 and September 27 2024 - March 27, 2025.

Link to data: https://waterdata.usgs.gov/state/north-carolina/ 

The 10 USGS stream gages we used are:
